...
class LabyrinthWindow (GObject.GObject):
    ...
    def __init__ (self, filename, imported=False):
        ...
        self.ui.get_object('/MenuBar/EditMenu').connect ('activate', self.edit_activated_cb)
        ...
        self.ui.get_object('/MenuBar/ViewMenu/ShowToolbars/ShowMainToolbar').set_active(True)
        self.ui.get_object('/MenuBar/ViewMenu/ShowToolbars/ShowFormatToolbar').set_active(True)
        self.ui.get_object('/MenuBar/ViewMenu/UseBezier').set_active(utils.use_bezier_curves)
        ...
        glade.get_object('align_vertical_left').connect('activate', self.align_cb, "vl")
        glade.get_object('align_vertical_right').connect('activate', self.align_cb, "vr")
        glade.get_object('align_vertical_center').connect('activate', self.align_cb, "vc")
        glade.get_object('align_horizontal_top').connect('activate', self.align_cb, "ht")
        glade.get_object('align_horizontal_bottom').connect('activate', self.align_cb, "hb")
        glade.get_object('align_horizontal_center').connect('activate', self.align_cb, "hc")
    ...
    def show(self):
        ...
        if os.name != 'nt':
            if not self.config_client.get_bool('/apps/labyrinth/show_tree_view'):
                ...
                self.ui.get_object('/MenuBar/ViewMenu/ViewOutline').set_active(True)
